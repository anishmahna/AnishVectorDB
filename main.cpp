// =====================================================================
//  AnishVectorDB — Built from scratch by Anish Mahna
//  A fully working Vector Database engine in C++
//  Implements HNSW, KD-Tree, Brute Force + RAG pipeline via Ollama
// =====================================================================
...
int main() {
    ...
    std::cout << "=== AnishVectorDB Engine — by Anish Mahna ===" << std::endl;
